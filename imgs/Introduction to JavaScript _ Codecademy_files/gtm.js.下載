...
"resource": {
  ...
  "rules":[
    [["if",0,1,2],["add",0,2]],
    [["if",0,2,3],["add",1]],
    [["if",1,2,4],["unless",5],["add",3,4,13,16,30,33,40]],
    [["if",2],["add",5,6,7,14,25,28,35,37,20,23,24]],
    [["if",2,6],["add",8,21]],
    [["if",2,7],["add",8]],
    [["if",2,8],["add",8]],
    [["if",2,9],["add",8,9]],
    [["if",2,10],["add",9]],
    [["if",2,11],["add",9]],
    [["if",12],["add",10,11,26,31,38]],
    [["if",1,2,4,5],["add",12,15,29,32,39]],
    [["if",13],["add",17]],
    [["if",2,14],["add",18]],
    [["if",15,16,17],["add",19]],
    [["if",2,18],["add",22]],
    [["if",19,20,21],["add",27]],
    [["if",2],["unless",22],["add",34]],
    [["if",2,23],["add",34]],
    [["if",24],["add",35]],
    [["if",23,25],["add",36]]]
},
...
function Tc(a){var b=[],c;for(c in a)if(a.hasOwnProperty(c)){var d=a[c];"AW"===d.prefix&&d.o[1]&&b.push(d.containerId)}for(var e=0;e<b.length;++e)delete a[b[e]]};var Vc={},Wc=null,Xc=Math.random();Vc.s="GTM-KTLK85W";Vc.Cb="340";var Yc={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},Zc="www.googletagmanager.com/gtm.js";var $c=Zc,bd=null,cd=null,dd=null,ed="//www.googletagmanager.com/a?id="+Vc.s+"&cv=72",fd={},gd={},hd=function(){var a=Wc.sequence||0;Wc.sequence=a+1;return a};var id={},jd=function(a,b){id[a]=id[a]||[];id[a][b]=!0},kd=function(a){for(var b=[],c=id[a]||[],d=0;d<c.length;d++)c[d]&&(b[Math.floor(d/6)]^=1<<d%6);for(var e=0;e<b.length;e++)b[e]="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(b[e]||0);return b.join("")};
...
Z.a.tg=["google"],function(){function a(k){h.push(k);1<h.length||I(function(){var l=h.join(",");h=[];ck({event:"gtm.triggerGroup","gtm.triggers":l})})}function b(k,l){var m=d[l],n=m.indexOf(k);-1!==n&&(m.splice(n,1),m.length||a(l))}function c(k){I(k.vtp_gtmOnSuccess);var l=k.vtp_uniqueTriggerId,m=k.vtp_triggerIds,n=k.vtp_firingId;if(k.vtp_isListeningTag){var r=e[n];r?b(n,r):f.push(n)}else{d[l]=m;for(var t=0,p;p=m[t];t++)e[p]=l;for(var u=0;u<f.length;u++)b(f[u],l)}}var d={},e={},f=[],h=[];Z.__tg=c;Z.__tg.b="tg";Z.__tg.g=!0;Z.__tg.priorityOverride=0}();
...
function(){var k=Lk(W("UET"),{ti:c.vtp_tagId,q:e});F[d]=k;k.push("pageLoad");c.vtp_gtmOnSuccess()},c.vtp_gtmOnFailure),a=!0}catch(k){I(c.vtp_gtmOnFailure)}};Z.__baut=b;Z.__baut.b="baut";Z.__baut.g=!0;Z.__baut.priorityOverride=0}();
